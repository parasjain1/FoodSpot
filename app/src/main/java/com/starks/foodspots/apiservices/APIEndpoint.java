...
public interface APIEndpoint {
    ...
    Call<FoodSpot> deleteFoodSpot(@Path("foodSpotId") String foodSpotId, @FieldMap() Map<String, String> map);

    @GET("foodspots/travel")
    Call<ArrayList<FoodSpot>> foodSpotsTravelling(@QueryMap() Map<String, String> map);

    @GET("users")
    Call<ArrayList<User>> getUsers(@QueryMap() Map<String, String> map);
